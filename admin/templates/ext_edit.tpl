...
<div align="center" style="text-align:center;">
	    	...
	    	<tr>
	    		...
	    		تعديل الامتداد ({ext.FType}) #{id}</td>
	    		<td class="Win_HL">
	    	...
	    	<tr>
	    		<td class="Win_R">&nbsp;</td>
	    		<td class="Win_C">
	    		<form action="attach.php?action=editext&id={id}" method="post">
	    		<table cellpadding="0" cellspacing="3" style="width: 100%">
	    			<tbody>
	    			<tr>
	    				<td style="width: 40%; height: 39px">
						<span class="Win_Elem">
						وصف الإمتداد &nbsp;:&nbsp;</span><br />
	    				</td>
	    				<td style="width: 60%; height: 39px">
						<input class="TextBox" value="{ext.FType}" name="FType" type="text" />&nbsp;</td>
	    			</tr>
	    			<tr>
	    			...
	    			<tr>
	    				...
	    				<td style="width: 60%; height: 39px">
						<input class="TextBox" value="{ext.FEXT}" name="FEXT" type="text" /></td>
	    			</tr>
	    			<tr>
	    				<td class="Win_Lin" colspan="2" style="height: 1px">
	    				<img alt="" height="1" src="images/spacer.gif" width="1" /></td>
	    			...
	    			<tr>
	    				...
	    				<td style="width: 60%; height: 39px">
						<input class="TextBox" value="{ext.FImage}" name="FImage" type="text" /></td>
	    			</tr>
	    		</tbody>
	    		</table>
	    		<br />
	    		<div style="text-align:center;">
	    		<input name="Submit1" type="submit" value="تعديل الامتداد" id="Button" />
	    		</div>
	    		</form>
	    		</td>
	    		<td class="Win_L">&nbsp;</td>
