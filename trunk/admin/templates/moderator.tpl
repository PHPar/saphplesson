...
<head>
  ...
  <title>المشرفين | سكربت الدروس العربي</title>
...
<div align="center" style="text-align:center;">
	    <table cellpadding="0" align="center" cellspacing="0" style="width: 90%">
	    	...
	    	<tr bgcolor="#F2F2F2|#DDDDDD" style="height:22px">
	    		...
	    		<a href="moderator.php?action=edit&id={{ModID}}" class="EditHref">تعديل</a></td>
	    		<td style="text-align: center">
                <IF Name="{{ModID}} eq 1">
	    		    <a onclick="alert('لايمكن حذف المشرف العام');return false;" href="#" class="Disabled">حذف</a></td>
                <ELSE>
                    <a onclick="return confirm('هل انت متأكد من حذف {{ModName}}');" href="moderator.php?action=delete&id={{ModID}}" class="DelHref">حذف</a></td>
                </IF>
	    		<td class="Win_L">&nbsp;</td>
	    	</tr>
            </LOOP>
