...
<head>
  ...
  <title>الملفات المرفقة | سكربت الدروس العربي</title>
...
<div align="center" style="text-align:center;">
	    <table cellpadding="0" align="center" cellspacing="0" style="width: 90%">
	    	...
	    	<tr bgcolor="#F2F2F2|#DDDDDD" style="height:22px">
	    		...
	    		<td style="text-align: center">
	    		<a href="attach.php?action=download&id={{AID}}" target="_blank" class="Disabled">تحميل</a></td>
	    		<td style="text-align: center">
                    <a onclick="return confirm('هل انت متأكد من حذف {{AName}}');" href="attach.php?action=delete&id={{AID}}" class="DelHref">حذف</a></td>
	    		<td class="Win_L">&nbsp;</td>
	    	</tr>
            </LOOP>
            <ELSE>
