...
<div align="center" style="text-align:center;">
	    	...
	    	<tr>
	    		<td class="Win_R">&nbsp;</td>
	    		<td class="Win_C">
	    		<form action="words.php?action=edit&id={id}" method="post">
	    		<table cellpadding="0" cellspacing="3" style="width: 100%">
	    			...
	    			<tr>
						...
						<input class="TextBox" value="{word.WFind}" name="Word" type="text" />&nbsp;</td>
	    			</tr>
	    			<tr>
	    			...
	    			<tr>
	    				...
	    				<td style="width: 60%; height: 39px">
						<input class="TextBox" value="{word.WReplace}" name="Alt" type="text" /></td>
	    			</tr>
	    		</tbody>
	    		</table>
	    		<br />
	    		<div style="text-align:center;">
	    		<input name="Submit1" type="submit" value="تعديل الكلمة" id="Button" />
	    		</div>
	    		</form>
	    		</td>
	    		<td class="Win_L">&nbsp;</td>
