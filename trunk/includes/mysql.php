...
|*#####################################################################*/
	...
	class db {
		...
		function db($dbuser, $dbpassword, $dbname, $dbhost)
		{
			...
			if ( ! $this->dbh )
			{
				$this->print_error("<ol><b>Œÿ√ ›Ì «·≈ ’«· »ﬁ«⁄œ… «·»Ì«‰« !</b><li>Â· √‰  „ √ﬂœ „‰ «”„ «·„” Œœ„ Êﬂ·„… «·„—Ê— ·ﬁ«⁄œ… «·»Ì«‰« ?<li>Â· √‰  „ √ﬂœ „‰ „” ÷Ì› ﬁ«⁄œ… «·»Ì«‰« ?<li>Â· √‰  „ √ﬂœ „‰ ”Ì—›— «·ﬁ«⁄œ… «·»Ì«‰«  »√‰Â Ì⁄„·?</ol>");
                exit;
			}
		...
		function select($db)
		{
			...
			{
				$this->print_error("<ol><b>Œÿ√ ›Ì «Œ Ì«— ﬁ«⁄œ… «·»Ì«‰«  <u>$db</u>!</b><li>Â· √‰  „ √ﬂœ „‰ √‰ ﬁ«⁄œ… «·»Ì«‰«  „ÊÃÊœ…?<li>Â· √‰  „ √ﬂœ „‰ √‰ﬂ —»ÿ  ﬁ«⁄œ… «·»Ì«‰«  »«”„ «·„” Œœ„ «·„Õœœ?</ol>");
                exit;
			}
		}
		...
		function print_error($str = "")
		{
			...
			print "<blockquote dir='rtl'><font face=Tahoma size=2 color=ff0000>";
			print "<b>Œÿ√ ›Ì ﬁ«⁄œ… «·»Ì«‰«  --</b> ";
